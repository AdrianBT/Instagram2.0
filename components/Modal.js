                                    ...
                                    <div>
                                        ...
                                        <div className='mt-5 sm:mt-6'>
                                            <button
                                                ...
                                                font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-offset-2 focus:ring-2 focus:ring-red-500 sm:text-sm disabled:bg-gray-300 disabled:cursor-not-allowed hover:disabled:bg-gray-300 "
                                                onClick={uploadPost}
                                           >
